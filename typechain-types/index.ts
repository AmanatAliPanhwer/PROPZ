...
export type { ThankReward } from "./blockchain/contracts/ThankReward";
export { ThankReward__factory } from "./factories/blockchain/contracts/ThankReward__factory";
export type { THANKToken } from "./blockchain/contracts/THANKToken";
export { THANKToken__factory } from "./factories/blockchain/contracts/THANKToken__factory";
