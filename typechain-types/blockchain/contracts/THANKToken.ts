...
export interface THANKTokenInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "BURNER_ROLE"
      | "DEFAULT_ADMIN_ROLE"
...
export interface THANKToken extends BaseContract {
  connect(runner?: ContractRunner | null): THANKToken;
  waitForDeployment(): Promise<this>;

  interface: THANKTokenInterface;
